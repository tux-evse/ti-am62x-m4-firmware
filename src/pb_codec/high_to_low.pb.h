...
#define _SLACState_MIN SLACState_DF
...
#define GetSLAC_init_default                     {_SLACState_MIN, 0}
...
#define GetSLAC_init_zero                        {_SLACState_MIN, 0}
#define CpuHeartbeat_init_zero                   {0}
#define HighToLow_init_zero                      {0, {SetPWM_init_zero}}

/* Field tags (for use in manual encoding/decoding) */
#define GetSLAC_state_tag                        1
#define GetSLAC_timer_tag                        2
...
#define HighToLow_get_slac_tag                   6
...
#define GetSLAC_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UENUM,    state,             1) \
X(a, STATIC,   SINGULAR, FLOAT,    timer,             2)
#define GetSLAC_CALLBACK NULL
#define GetSLAC_DEFAULT NULL
...
X(a, STATIC,   ONEOF,    MESSAGE,  (message,get_slac,message.get_slac),   6)
...
#define HighToLow_message_get_slac_MSGTYPE GetSLAC

extern const pb_msgdesc_t Empty_msg;
extern const pb_msgdesc_t SetPWM_msg;
extern const pb_msgdesc_t GetSLAC_msg;
...
#define GetSLAC_fields &GetSLAC_msg
