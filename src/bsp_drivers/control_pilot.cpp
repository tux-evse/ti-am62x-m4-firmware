...
void ControlPilot::set_pwm(float duty_cycle) {
    ...
    //TMA : DebugP_log("IOCTRL DC: %d \r\n",duty_cycle);
    //TMA : DebugP_log("IOCTRL Ticks: %d \r\n",match_ticks);
...
//FCAM PP function using CP class
iec61851::PPSignal ControlPilot::get_pp_signal() {
    return sampler.get_latest_pp_signal();
}
